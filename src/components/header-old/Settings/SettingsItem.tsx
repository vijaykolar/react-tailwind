...
function SettingsItem({ setting }: SettingsItemTypes) {
  return (
    <li
      key={setting.id}
      className="text-center p-2 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-md transition-all"
    >
      <button>
        <div>
          <img
        ...
        <span className="text-gray-700 dark:text-gray-400 text-xs capitalize">
          {setting.title}
        </span>
      </button>
    </li>
