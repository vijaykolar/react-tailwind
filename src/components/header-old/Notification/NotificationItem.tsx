...
function NotificationItem({
  ...
  const statusClasses =
    status === "busy"
      ...
      : "bg-yellow-500";
  return (
    <li className="flex gap-x-3 w-full p-3 border-b border-gray-300 dark:border-gray-600">
      <div>
      ...
      <div className="flex-1">
        <div className="flex items-center">
          <h6 className="text-sm text-gray-700 dark:text-gray-400 font-semibold mb-1 flex-1">
            {name}
          </h6>
